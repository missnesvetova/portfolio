...
Такие навыки как **SQL**, **Python** и **BI-инструменты** (в первую очередь Power BI) — развиваю, решая кейсы, которые близки к задачам коммерческой, продуктовой и бизнес аналитики. Один из последних кейсов — **сравнительный анализ котировок Tesla и Rivian**, где я:
