...
Привет! Меня зовут Анна. Я аналитик уровня Junior+. Сейчас основной вектор развития в аналитике направлен на задачи в области финансовой и бизнес-аналитики для поддержки управленческих решений.
Более продвинутые навыки — **SQL**, **Python** и **BI-инструменты** (в первую очередь Power BI) — развиваю, решая практические кейсы. Один из таких — **сравнительный анализ котировок Tesla и Rivian**, где я:
